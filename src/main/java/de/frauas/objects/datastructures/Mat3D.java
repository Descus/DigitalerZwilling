...
public class Mat3D {
    ...
    public Mat3D(double m00, double m01, double m02, double m10, double m11, double m12, double m20, double m21, double m22) {
        this.m00 = m00;
        this.m01 = m01;
        this.m02 = m02;
        this.m10 = m10;
    ...
    public static final Mat3D ZERO = 
            new Mat3D(
                    0, 0, 0, 
                    0, 0, 0,
                    0,0, 0);
    
    public static final Mat3D ONE = 
            new Mat3D(
                    1, 1, 1, 
                    1, 1, 1,
                    1, 1, 1);
